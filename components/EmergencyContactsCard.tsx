    ...
    <Card overrideStyles={styles.emergencyContactsCard}>
      <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View style={styles.emergencyContactsCardBody}>
          ...
          <View style={styles.emergencyContactRow}>
            <View style={styles.emergencyContact}>
              <C4kText style={styles.emergencyContactNameText}>Pat Nabors</C4kText>
              <C4kText style={styles.emergencyContactTitleText}>Lebanon Coordinator</C4kText>
            </View>
            <FontAwesome5
              name="phone-alt"
              size={8}
              color="#FFF"
              style={{ backgroundColor: "#23A57F", borderRadius: 3, padding: 5, margin: 5 }}
              onPress={() => Linking.openURL("tel://6159695847")}
            />
          </View>
          <View style={styles.emergencyContactDivider}></View>
          <View style={styles.emergencyContactRow}>
            <View style={styles.emergencyContact}>
              <C4kText style={styles.emergencyContactNameText}>Sue Morrison</C4kText>
              <C4kText style={styles.emergencyContactTitleText}>Sunday Coordinator</C4kText>
            </View>
            <FontAwesome5
              name="phone-alt"
              size={8}
              color="#FFF"
              style={{ backgroundColor: "#23A57F", borderRadius: 3, padding: 5, margin: 5 }}
              onPress={() => Linking.openURL("tel://8034953267")}
            />
          </View>
        </View>
      </ScrollView>
