...
const createVolunteer = (firestoreVolunteer: any) => {
  const volunteer: Volunteer = {
    ...
    firstName: firestoreVolunteer.firstName,
    lastName: firestoreVolunteer.lastName,
    lastNameLower: firestoreVolunteer.lastNameLower,
    fullName: firestoreVolunteer.firstName.toLowerCase() + " " + firestoreVolunteer.lastNameLower,
